...
export const changelog: ChangelogEntry[] = [
  {
    ...
    changes: [
      ...
      { type: "fix", description: "Team leads no longer get assigned mid shifts when opener or closer slots are still empty. Previously, mid was always in the random pick pool, so a team lead had a coin-flip chance of getting a mid instead of filling a critical opener/closer gap." },
