    ...
    <>
      ...
      <aside className="hidden lg:flex flex-col w-64 h-screen border-r bg-card fixed left-0 top-0 z-50">
        <div className="p-4 border-b flex flex-col items-center">
          <img src={goodshiftLogo} alt="GoodShift" className="h-20 w-auto" data-testid="img-logo-sidebar" />
      ...
      <header className="lg:hidden fixed top-0 left-0 right-0 h-16 border-b bg-card/80 backdrop-blur-md z-50 flex items-center px-4 justify-between">
        <img src={goodshiftLogo} alt="GoodShift" className="h-10 w-auto" />
        ...
        <div className="flex items-center gap-2">
          ...
          <SheetContent side="left" className="w-64 p-0">
            <div className="p-4 border-b flex flex-col items-center">
              <img src={goodshiftLogo} alt="GoodShift" className="h-20 w-auto" data-testid="img-logo-mobile" />
            </div>
            <nav className="flex-1 p-4 space-y-2">
              {navItems.map((item) => (
                <Link key={item.href} href={item.href}>
