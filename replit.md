...
- **Production Station Limits**: Configurable per-location limits for Apparel Processor and Donation Pricing stations. The AI scheduler respects these limits when generating schedules, and the validator warns when daily station limits are exceeded. A value of 0 means unlimited.
